...
public interface ProyectoDao extends IntGenericoCrud <String, Proyecto>  {
	...
	int diasATerminoProyectoActivo(String codigoProyecto); //Cuantos dias quedan para terminar el 
															//proyecto (diferencia entre fecha_fin_previsto y la fecha de hoy)
